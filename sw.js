const CACHE_NAME = "ai-food-trainer-pwa-v28";
const scopeUrl = (path) => new URL(path, self.registration.scope).toString();
const ASSETS = [
  scopeUrl("index.html"),
  scopeUrl("disclaimer.html"),
  scopeUrl("styles.css?v=20260705-g3-canon-v5"),
  scopeUrl("app.js?v=20260705-g3-canon-v5"),
  scopeUrl("manifest.webmanifest?v=20260705-g3-canon-v5"),
